...
namespace CSTable
{
	...
	/// 构造函数;
	/// </summary>
	public class ItemEquipData:IItemBase{
		public ItemEquipData()		
		{				
		}

		public ItemEquipData(string _value)		
		{				
			...
			id = StaticDataManager.stringToInt(array[0]);
				...
				EquipType = StaticDataManager.stringToInt(array[20]);
				HandType = StaticDataManager.stringToByte(array[21]);
				AppearRes = array[22];
				MaxLevel = StaticDataManager.stringToInt(array[23]);
				MaxRefineLv = StaticDataManager.stringToInt(array[24]);
