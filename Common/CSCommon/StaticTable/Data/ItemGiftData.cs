...
namespace CSTable
{
	...
	/// 构造函数;
	/// </summary>
	public class ItemGiftData:IItemBase{
		public ItemGiftData()		
		{				
		}

		public ItemGiftData(string _value)		
		{				
			...
			id = StaticDataManager.stringToInt(array[0]);
				...
				AddIntimacy = StaticDataManager.stringToInt(array[20]);
				BuyCurrenceType = StaticDataManager.stringToInt(array[21]);
				PurchasePrice = StaticDataManager.stringToInt(array[22]);
