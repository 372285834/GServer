...
namespace RPC
{
    ...
    public class PackageWriter
    {
        ...
        #region Send Package
        public void SendBuffer(Iocp.NetConnection conn)
	    {
            //int length = 0;
            ...
            else
            {
                ...
                Log.Log.Common.Print("Error!!SendBuffer mPos>=65535-2");
            }
	    }

        public void DoCommand(Iocp.NetConnection conn, CommandTargetType target)
	    {
		    switch (target)
		    {
	    ...
	    public void DoReturnCommand2(Iocp.NetConnection conn,System.UInt16 serialId)
	    {
		    SerialId = serialId;
            PkgType = PackageType.PKGT_Return;
		    SendBuffer(conn);
        ...
        public void DoCommandPlanes2Client(Iocp.NetConnection conn, System.UInt16 clientLinkId)
	    {
		    Write(clientLinkId);
        ...
        public void DoReturnPlanes2Client(Iocp.NetConnection p2gConnect, UInt16 clientLinkeId, UInt16 serialId)
        {
            SerialId = serialId;
            Write(clientLinkeId);
        ...
        public void DoClient2Planes(Iocp.NetConnection conn)
	    {
		    PkgType = PackageType.PKGT_C2P_Send;
		    SendBuffer(conn);
	    }

        public RPCWaitHandle WaitDoClient2Planes(Iocp.NetConnection conn)
	    {
		    PkgType = PackageType.PKGT_C2P_SendAndWait;
        ...
        public void DoClient2PlanesPlayer(Iocp.NetConnection conn)
	    {
