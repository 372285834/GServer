...
namespace RPC
{
	...
	public delegate System.Object FEntranceExecute(int limitLevel,Iocp.NetConnection connect,RPCObject rootObj , PackageProxy pkg,RPCForwardInfo fwd);
...
#region 标志RPC的(类，子对象，索引器，函数的属性)
	...
	public class RPCMethodAttribute : System.Attribute
	{
		...
		public RPCMethodAttribute(int Level,bool noClient)
		{
            LimitLevel = Level;
			NoClientCall = noClient;
		}
